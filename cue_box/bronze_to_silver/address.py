...
# MAGIC |Input Datasets |<ul><li>data_lake_base_uri+/bronze/address_source_system/address/{schedule_date}/*.csv"</li></ul>|
# MAGIC |Output Datasets |<ul><li>data_lake_base_uri+/silver/address_source_system/address/</li></ul>|
...
# MAGIC |:----:|--------------|--------|
# MAGIC | 2023-12-28| Sagar Omar |onboarding the address data to datalake - silver layer|
...
# DBTITLE 1,generate pincode
generate_pin_code = bronze_layer_df.withColumn("pin_code", split("address", " ")[size(split("address", " "))-1])

# COMMAND ----------

# DBTITLE 1,add audit date
final_df = generate_pin_code.withColumn("load_date", lit(schedule_date))
