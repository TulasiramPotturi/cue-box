...
# MAGIC %md
# MAGIC #  Payments Data Onboarding
# MAGIC
# MAGIC ## Overview
# MAGIC
...
# MAGIC |Input Datasets |<ul><li>data_lake_base_uri+/bronze/payments_source_system/payments/{schedule_date}/*.csv"</li></ul>|
# MAGIC |Output Datasets |<ul><li>data_lake_base_uri+/silver/payments_source_system/payments/</li></ul>|
...
# MAGIC |:----:|--------------|--------|
# MAGIC | 2023-12-28| Sagar Omar |onboarding the payments data to datalake - silver layer|
...
# DBTITLE 1,Convert Epoch to timestamp
epoch_to_timestamp = convert_epoch_columns_to_datetime(bronze_layer_df,['payment_date'])

# COMMAND ----------

# DBTITLE 1,add currency column
add_currency = epoch_to_timestamp.withColumn("currency", lit("USD"))
