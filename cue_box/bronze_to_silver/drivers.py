...
# MAGIC |Input Datasets |<ul><li>data_lake_base_uri+/bronze/drivers_source_system/drivers/{schedule_date}/*.csv"</li></ul>|
# MAGIC |Output Datasets |<ul><li>data_lake_base_uri+/silver/drivers_source_system/drivers/</li></ul>|
...
# MAGIC |:----:|--------------|--------|
# MAGIC | 2023-12-28| Sagar Omar |onboarding the drivers data to datalake - silver layer|
...
fix_phone_numbers = bronze_layer_df.withcolumn("phone", replace_characters(hash_emails, replacement_dict))
